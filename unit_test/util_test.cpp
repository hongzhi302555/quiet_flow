...
TEST_F(TestInit, test_set) {
  ...
  EXPECT_EQ(vec_s, std::vector<uint64_t>({40}));
  ...
  EXPECT_FALSE(bit_map_get(bit_map, 41, 63));
  EXPECT_EQ(vec_s, std::vector<uint64_t>({32, 40}));
  ...
  EXPECT_FALSE(bit_map_get(bit_map, 41, 63));
  EXPECT_EQ(vec_s, std::vector<uint64_t>({18, 32, 40}));
  ...
  EXPECT_FALSE(bit_map_get(bit_map, 41, 63));
  EXPECT_EQ(vec_s, std::vector<uint64_t>({18, 32, 40, 62}));
  ...
  EXPECT_EQ(vec_s, std::vector<uint64_t>({0, 18, 32, 40, 62}));
